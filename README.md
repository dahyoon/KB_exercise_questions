...
### 단원 06 - Servlet, JSP, JSTL 기반 서버 프로그래밍 [✨완료✨]
...
### 단원 07 - Spring Framework를 활용한 애플리케이션 개발 [🔥진행중🔥]
...
| 03 Spring-MyBatis 연동             | `03_SPRING(basic_advance)`   |  ✅  | `03_SPRING(basic_advance)`   |  ✅  |
| 04 Spring 기본 게시판               | `04_SPRING(basic_advance)`   |  ✅  | `04_SPRING(basic_advance)`   |  ✅  |
| 05 Spring 기본 게시판, 파일 업로드     | `05_SPRING(basic_advance)`   |  ✅  | `05_SPRING(basic_advance)`   |  ✅  |
| 06 Rest, OpenAPI                  | `06_SPRING(basic_advance)`  |  ✅  | `06_SPRING(basic_advance)`    |  ✅  |
